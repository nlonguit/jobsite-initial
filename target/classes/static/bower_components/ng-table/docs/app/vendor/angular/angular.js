...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *     Any commits to this file should be reviewed with jobsite.security in mind.  *
 *   Changes to this file can potentially create jobsite.security vulnerabilities. *
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
   ...
   *
   * The sanitization is a jobsite.security measure aimed at preventing XSS attacks via html links.
   *
   ...
   *
   * The sanitization is a jobsite.security measure aimed at prevent XSS attacks via html links.
   *
